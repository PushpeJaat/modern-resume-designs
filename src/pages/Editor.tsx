  ...
  experience: [
    {
      ...
      responsibilities: [
        ...
        "Mentor team of 5 junior developers on best practices and code reviews",
        "Reduced deployment time by 60% through CI/CD pipeline optimization",
        "Architected event-driven system handling 50K+ events per second",
      ],
    },
    {
      id: "2",
      ...
      current: false,
      responsibilities: [
        "Built real-time data pipeline processing 10TB+ daily using Apache Kafka",
        "Designed and implemented GraphQL API layer reducing frontend load times by 45%",
        "Led migration from monolith to microservices, improving system uptime to 99.99%",
      ],
    },
    {
      id: "3",
      ...
      current: false,
      responsibilities: [
        "Built and maintained React-based customer dashboard used by 50K+ users",
        "Implemented RESTful APIs using Node.js and Express with 99.9% uptime",
        "Collaborated with design team to improve UX metrics by 40%",
        "Integrated Stripe payment system processing $2M+ monthly transactions",
      ],
    },
    {
      id: "4",
      ...
      responsibilities: [
        ...
        "Built responsive email templates reaching 500K+ subscribers",
      ],
    },
    {
      id: "5",
      ...
      current: false,
      responsibilities: [
        "Developed and maintained 20+ client websites using WordPress and custom PHP",
        "Created cross-browser compatible responsive layouts with CSS3 and JavaScript",
        "Assisted senior developers in building e-commerce platforms with 10K+ products",
      ],
    },
    {
      id: "6",
      ...
      current: false,
      responsibilities: [
        "Delivered 15+ freelance web projects for small businesses on time and budget",
        "Built custom CMS solutions reducing client content update time by 70%",
        "Provided ongoing maintenance and SEO optimization for client portfolios",
      ],
    },
  ],
  education: [
