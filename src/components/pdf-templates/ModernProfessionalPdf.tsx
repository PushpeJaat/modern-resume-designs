...
const s = StyleSheet.create({
  ...
  bullet: { fontSize: 9, lineHeight: 1.4, color: colors.darkGray, marginBottom: 2, paddingLeft: 8 },
  summary: { fontSize: 9, lineHeight: 1.5, color: colors.darkGray, marginBottom: 6 },
          ...
          <View style={s.leftCol}>
            ...
            {d.education.length > 0 && d.education[0].institution && (
              <View style={s.section}>
                ...
                {d.education.map((edu) => (
                  <View key={edu.id} style={{ marginBottom: 6 }} minPresenceAhead={40}>
